...
<head>
    ...
    <title>Etlas Cheatsheet | The Eta Programming Language</title>
      ...
      <div class='container hero-content col middle-xs'>
          <div class='row'>
              <div class='col-xs-12 col-sm-12 col-lg-12 color--white'>
                  <h1 class='heading--large'>Etlas Cheatsheet</h1>

                  <p class='text--large mt--20'>A quick reference for Etlas</p>
      ...
      <span class="nf">main</span> <span class="ow">=</span> <span class="n">putStrLn</span> <span class="s">&quot;Hello World!&quot;</span>
          ...
          Basics
            ...
            Etlas initializing
                        ...
                        <p>Usage: <span class="inline-code">etlas init [FLAGS]</span>
                        <p class="mt--20 pb--20 pt--20 pl--20 color--white" style="background: #1C3041; font-family: 'Cousine', monospace; font-size: 12px;">$ etlas init</p>
                    </div>
          ...
          Etlas build
                      ...
                      <p>Usage: <span class="inline-code">etlas build [TARGETS] [FLAGS]</span>
          ...
          Etlas update
                      ...
                      <p>Usage: <span class="inline-code">etlas update</span>
                      <p class="mt--20 pb--20 pt--20 pl--20 color--white" style="background: #1C3041; font-family: 'Cousine', monospace; font-size: 12px;">$ etlas update</p>
                  </div>
                </div>
            </div>

            <div class='row mt--20 center-xs pt--50 pb--100'>
            ...
            Etlas help
                        ...
                        <p>Usage: <span class="inline-code">etlas --help</span> or <span class="inline-code">etlas --h</span>
                        <p class="mt--20 pb--20 pt--20 pl--20 color--white" style="background: #1C3041; font-family: 'Cousine', monospace; font-size: 12px;">$ etlas --help</p>
                    </div>
          ...
          Etlas version
                      ...
                      <p>Usage: <span class="inline-code">etlas --version</span> or <span class="inline-code">etlas --v</span>
                      <p class="mt--20 pb--20 pt--20 pl--20 color--white" style="background: #1C3041; font-family: 'Cousine', monospace; font-size: 12px;">$ etlas --version</p>
                  </div>
                </div>
                <div class='col-xs-12 col-sm-4 mt--xs--20'>
                  <div class='box box--padding--top--20 text--left'>
          ...
          Etlas numeric version only
                      ...
                      <p>Usage: <span class="inline-code">etlas --numeric-version</span>
                      <p class="mt--20 pb--20 pt--20 pl--20 color--white" style="background: #1C3041; font-family: 'Cousine', monospace; font-size: 12px;">$ etlas --numeric-version</p>
                  </div>
                </div>
            </div>
        </div>
