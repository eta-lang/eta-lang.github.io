...
<head>
    ...
    <title>Eta - Documentation</title>
    <link rel="canonical" href="https://eta-lang.org" />
    <meta name="keywords" content="Documentation, Docs, Eta, Haskell, Scala, Clojure, JVM, Functional Programming, Functional Programming on the JVM, Java Virtual Machine">
        ...
        <div class='container hero-content col middle-xs'>
            <div class='row'>
                <div class='col-xs-12 col-sm-12 col-lg-12 color--white'>
                    <h1 class='heading--large'><indexTitle/></h1>

                    <p class='text--large mt--20'><indexDescription/></p>
                ...
                <div class='box'>
                    <div class='row gutter-medium middle-xs center-xs start-sm'>
                        <div class='col-xs-12 col-sm-4 text--center'>
                            <img alt="Eta Cheatsheet" src='/images/guides.svg'>
                        </div>
                        <div class='col-xs-12 col-sm-8'>
                            <h4 class='mb--10 heading--small'>
                                <a class='text--link' href='/docs/cheatsheets'>
              Cheatsheets           </a>
                            </h4>
                            <p>
                                A quick reference to Eta
                            </p>

                            <a class='mt--20 button--small button--ghost--purple' href="/docs/cheatsheets">
            Learn More          </a>
                ...
                <div class='box'>
                    <div class='row gutter-medium middle-xs center-xs start-sm'>
                        ...
                        <div class='col-xs-12 col-sm-8'>
                            <h4 class='mb--10 heading--small'>
                                <a class='text--link' href='https://tour.eta-lang.org'>
              Tour of Eta            </a>
                            </h4>
                            <p>
                            ...
                            <a class='mt--20 button--small button--ghost--purple' href="https://tour.eta-lang.org">
            Learn More          </a>
                ...
                <div class='box'>
                    <div class='row gutter-medium middle-xs center-xs start-sm'>
                        ...
                        <div class='col-xs-12 col-sm-8'>
                            <h4 class='mb--10 heading--small'>
                                <a class='text--link' href='/docs/user-guides/eta-user-guide/java-interop/java-interop-basics'>
              Interacting with Java            </a>
                            </h4>
                            <p>
                                Learn how Eta handles different Java elements.
                            </p>

                            <a class='mt--20 button--small button--ghost--purple' href="/docs/user-guides/eta-user-guide/java-interop/java-interop-basics">
            Learn More          </a>
                ...
                <div class='box'>
                    <div class='row gutter-medium middle-xs center-xs start-sm'>
                        ...
                        <div class='col-xs-12 col-sm-8'>
                            <h4 class='mb--10 heading--small'>
                                <a class='text--link' href='/docs/user-guides/eta-user-guide/introduction/what-is-eta'>
              Getting started with Eta            </a>
                            </h4>
                            <p>
                                Read up Eta's background, installation process.
                            </p>

                            <a class='mt--20 button--small button--ghost--purple' href="/docs/user-guides/eta-user-guide/introduction/what-is-eta">
            Learn More          </a>
